...
is($entity_common->entity_size, 42, 'Entity size (42).');
is($shape1_data->x, 1, 'Shape x (1).');
is($shape1_data->y, 1, 'Shape y (1).');
is($shape1_data->height, 1.2345, 'Shape height (1.2345).');
is($shape1_data->item_num, 131, 'Shape item number (131).');
is($shape1_data->angle_in_radians, 0.593411945678072, 'Shape angle in radians (0.593411945678072).');
