...
sub _read {
    ...
    for (my $i = 0; $i < $n_table_blocks; $i++) {
        push @{$self->{table_blocks}}, CAD::Format::DWG::AC2_10::Block->new($self->{_io}, $self, $self->{_root});
    }
    $self->{table_layers} = ();
    my $n_table_layers = $self->header()->table_layer()->items();
    for (my $i = 0; $i < $n_table_layers; $i++) {
        push @{$self->{table_layers}}, CAD::Format::DWG::AC2_10::Layer->new($self->{_io}, $self, $self->{_root});
    }
    $self->{table_styles} = ();
    my $n_table_styles = $self->header()->table_style()->items();
    for (my $i = 0; $i < $n_table_styles; $i++) {
        push @{$self->{table_styles}}, CAD::Format::DWG::AC2_10::Style->new($self->{_io}, $self, $self->{_root});
    }
    $self->{table_linetypes} = ();
    my $n_table_linetypes = $self->header()->table_linetype()->items();
    for (my $i = 0; $i < $n_table_linetypes; $i++) {
        push @{$self->{table_linetypes}}, CAD::Format::DWG::AC2_10::Linetype->new($self->{_io}, $self, $self->{_root});
    }
    $self->{table_views} = ();
    my $n_table_views = $self->header()->table_view()->items();
    for (my $i = 0; $i < $n_table_views; $i++) {
        push @{$self->{table_views}}, CAD::Format::DWG::AC2_10::View->new($self->{_io}, $self, $self->{_root});
    }
    ...
    $self->{entities_block} = CAD::Format::DWG::AC2_10::RealEntities->new($io__raw_entities_block, $self, $self->{_root});
    if ($self->header()->extra_entities_start() > 0) {
        ...
        $self->{entities_extra} = CAD::Format::DWG::AC2_10::RealEntities->new($io__raw_entities_extra, $self, $self->{_root});
    }
    if (!($self->_io()->is_eof())) {
        $self->{todo} = ();
...
sub _read {
    ...
    $self->{flags} = CAD::Format::DWG::AC2_10::AttrFlags->new($self->{_io}, $self, $self->{_root});
...
########################################################################
package CAD::Format::DWG::AC2_10::LinetypeFlag;
...
########################################################################
package CAD::Format::DWG::AC2_10::BlockFlag;
...
########################################################################
package CAD::Format::DWG::AC2_10::Pattern;
...
sub _read {
    ...
    $self->{corner2} = CAD::Format::DWG::AC2_10::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{corner3} = CAD::Format::DWG::AC2_10::Point2d->new($self->{_io}, $self, $self->{_root});
    $self->{corner4} = CAD::Format::DWG::AC2_10::Point2d->new($self->{_io}, $self, $self->{_root});
}
...
sub _read {
    ...
    $self->{flag} = CAD::Format::DWG::AC2_10::StyleFlag->new($self->{_io}, $self, $self->{_root});
...
########################################################################
package CAD::Format::DWG::AC2_10::PolylineFlags;
...
########################################################################
package CAD::Format::DWG::AC2_10::AttrFlags;
...
sub _read {
    ...
    $self->{flag} = CAD::Format::DWG::AC2_10::LinetypeFlag->new($self->{_io}, $self, $self->{_root});
    ...
    $self->{pattern} = CAD::Format::DWG::AC2_10::Pattern->new($self->{_io}, $self, $self->{_root});
}
...
########################################################################
package CAD::Format::DWG::AC2_10::StyleFlag;
...
########################################################################
package CAD::Format::DWG::AC2_10::UnknownRepeating;
...
########################################################################
package CAD::Format::DWG::AC2_10::ViewFlag;
...
sub _read {
    ...
    $self->{flag} = CAD::Format::DWG::AC2_10::LayerFlag->new($self->{_io}, $self, $self->{_root});
...
########################################################################
package CAD::Format::DWG::AC2_10::EntityJump;
...
########################################################################
package CAD::Format::DWG::AC2_10::GenerationFlags;
...
sub _read {
    ...
    if ($self->entity_common()->flag2_1()) {
        $self->{end_point} = CAD::Format::DWG::AC2_10::Point2d->new($self->{_io}, $self, $self->{_root});
    }
}
...
########################################################################
package CAD::Format::DWG::AC2_10::HeaderVariables;
...
sub _read {
    ...
    $self->{view_point_x} = CAD::Format::DWG::AC2_10::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_point_y} = CAD::Format::DWG::AC2_10::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_point_z} = CAD::Format::DWG::AC2_10::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_point_x_alt} = CAD::Format::DWG::AC2_10::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_point_y_alt} = CAD::Format::DWG::AC2_10::Point3d->new($self->{_io}, $self, $self->{_root});
    $self->{view_point_z_alt} = CAD::Format::DWG::AC2_10::Point3d->new($self->{_io}, $self, $self->{_root});
...
sub _read {
    ...
    elsif ($_on == $CAD::Format::DWG::AC2_10::ENTITIES_JUMP) {
        $self->{data} = CAD::Format::DWG::AC2_10::EntityJump->new($self->{_io}, $self, $self->{_root});
    }
...
########################################################################
package CAD::Format::DWG::AC2_10::LayerFlag;
...
sub _read {
    ...
    if ($self->entity_common()->flag2_8()) {
        $self->{flag} = CAD::Format::DWG::AC2_10::PolylineFlags->new($self->{_io}, $self, $self->{_root});
    }
    if ($self->entity_common()->flag2_7()) {
        $self->{start_width} = $self->{_io}->read_f8le();
    }
...
sub _read {
    ...
    $self->{flag} = CAD::Format::DWG::AC2_10::ViewFlag->new($self->{_io}, $self, $self->{_root});
